...
Summary: Rich Mogull, chief analyst with the Cloud Security Alliance, joins the Dark Reading News Desk with what defenders need to take away from AI agents escaping their environments to launch attacks.
...
### Title: Wiz Penetration Test Findings is now GA
Link: https://www.wiz.io/blog/wiz-pen-test-findings-is-now-ga
Summary: Transform point-in-time pen-tests into continuous exposure management with unified platform combining pen-test findings and real-time cloud context
...
Summary: The people-search tool ClarityCheck says its reverse image search service is “private and secure”—but it left a database containing more than 9 million image files exposed.
...
Summary: One advertisement featured a pornographic video with a deepfake closely resembling a prominent US politician. Apple removed the app from the App Store after an inquiry from WIRED.
...
Summary: Proton’s CEO is a champion of encryption for everyone. So why is he going all in on un-encryptable AI?

### Title: The Cop Who Took On Flock
Link: https://www.wired.com/story/the-cop-who-took-on-flock/
Summary: After Noel Pichardo called out his city's embrace of Flock surveillance cameras, he was subjected to five internal affairs investigations in less than two years.

### Title: Virtual Event Today: CodeSecCon – Secure Your Code and Applications
Link: https://www.securityweek.com/virtual-event-today-codeseccon-secure-your-code-and-applications/
...
<p>The post <a href="https://www.securityweek.com/virtual-event-today-codeseccon-secure-your-code-and-applications/">Virtual Event Today: CodeSecCon &#8211; Secure Your Code and Applications</a> appeared first on <a href="https://www.securityweek.com">SecurityWeek</a>.</p>

### Title: Prevalent AI Raises $22 Million to Expand Data Fabric Platform
Link: https://www.securityweek.com/prevalent-ai-raises-22-million-to-expand-data-fabric-platform/
Summary: <p>The previously bootstrapped company helps organizations securely and reliably operate AI agents at scale.</p>
<p>The post <a href="https://www.securityweek.com/prevalent-ai-raises-22-million-to-expand-data-fabric-platform/">Prevalent AI Raises $22 Million to Expand Data Fabric Platform</a> appeared first on <a href="https://www.securityweek.com">SecurityWeek</a>.</p>

### Title: US Charges 17 Iranian Hackers, Offers $10 Million Rewards for 5 of Them
Link: https://www.securityweek.com/us-charges-17-iranian-hackers-offers-10-million-rewards-for-5-of-them/
Summary: <p>The 17 members of the Mabna Institute targeted hundreds of universities and organizations in the US and abroad.</p>
<p>The post <a href="https://www.securityweek.com/us-charges-17-iranian-hackers-offers-10-million-rewards-for-5-of-them/">US Charges 17 Iranian Hackers, Offers $10 Million Rewards for 5 of Them</a> appeared first on <a href="https://www.securityweek.com">SecurityWeek</a>.</p>

### Title: Cl0p Ransomware Group Names Over 40 Victims of PTC Windchill Campaign
Link: https://www.securityweek.com/cl0p-ransomware-group-names-over-40-victims-of-ptc-windchill-campaign/
Summary: <p>The cybercrime gang has listed major companies such as Shell, Philips, Fiserv, Zebra, Mindray, and Largan Precision.</p>
...
### Title: CISA Urges Immediate Patching of Exploited Microsoft, VMware, Apple Vulnerabilities
Link: https://www.securityweek.com/cisa-urges-immediate-patching-of-exploited-microsoft-vmware-apple-vulnerabilities/
Summary: <p>The flaws can be exploited for remote code execution, authentication bypass, and device takeover.</p>
...
### Title: 943 Patches Rolled Out With Oracle’s August 2026 Security Update
Link: https://www.securityweek.com/943-patches-rolled-out-with-oracles-august-2026-security-update/
Summary: <p>The fixes resolve over 1,000 vulnerabilities across two dozen products, including over 460 remotely exploitable bugs.</p>
<p>The post <a href="https://www.securityweek.com/943-patches-rolled-out-with-oracles-august-2026-security-update/">943 Patches Rolled Out With Oracle&#8217;s August 2026 Security Update</a> appeared first on <a href="https://www.securityweek.com">SecurityWeek</a>.</p>

### Title: Chrome, Firefox Updates Patch Dozens of Vulnerabilities
Link: https://www.securityweek.com/chrome-firefox-updates-patch-dozens-of-vulnerabilities/
Summary: <p>The bugs could lead to code execution, privilege escalation, sandbox escape, and information disclosure.</p>
<p>The post <a href="https://www.securityweek.com/chrome-firefox-updates-patch-dozens-of-vulnerabilities/">Chrome, Firefox Updates Patch Dozens of Vulnerabilities</a> appeared first on <a href="https://www.securityweek.com">SecurityWeek</a>.</p>
...
Summary: <p>The data breach was initially believed to affect roughly 350,000 people, but the HHS breach tracker shows a far bigger impact.</p>
<p>The post <a href="https://www.securityweek.com/carecloud-data-breach-impact-grows-to-3-7-million-individuals/">CareCloud Data Breach Impact Grows to 3.7 Million Individuals</a> appeared first on <a href="https://www.securityweek.com">SecurityWeek</a>.</p>

### Title: Webinar Today: Rethinking Cyber Defense for AI-Speed Attacks
Link: https://www.securityweek.com/webinar-today-rethinking-cyber-defense-for-ai-speed-attacks/
Summary: <p>Join the live webinar as we explore if detection-first security operations can keep pace with AI, or if it’s time to rethink prevention as the strongest default.</p>
...
### Title: CISO Conversations: Nico Waisman – From Self-Taught Hacker to AI-Driven Offensive Security at XBOW
Link: https://www.securityweek.com/ciso-conversations-nico-waisman-from-self-taught-hacker-to-ai-driven-offensive-security-at-xbow/
Summary: <p>With no formal training and no career plan, Waisman built a path from Argentina's early hacking scene to leading security at an AI-powered offensive security firm.</p>
...
### Title: ISC Stormcast For Wednesday, August 19th, 2026 https://isc.sans.edu/podcastdetail/10058, (Wed, Aug 19th)
Link: https://isc.sans.edu/diary/rss/33258
Summary: No summary available

### Title: ISC Stormcast For Tuesday, August 18th, 2026 https://isc.sans.edu/podcastdetail/10056, (Tue, Aug 18th)
