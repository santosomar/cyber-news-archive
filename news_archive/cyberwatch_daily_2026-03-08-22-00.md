...
Summary: OpenAI on Friday began rolling out Codex Security, an artificial intelligence (AI)-powered security agent that's designed to find, validate, and propose fixes for vulnerabilities.
...
Summary: Anthropic on Friday said it discovered 22 new security vulnerabilities in the Firefox web browser as part of a security partnership with Mozilla.
...
### Title: Recent Cisco Catalyst SD-WAN Vulnerability Now Widely Exploited
Link: https://www.securityweek.com/recent-cisco-catalyst-sd-wan-vulnerability-now-widely-exploited/
Summary: <p>WatchTowr reports seeing exploitation attempts for CVE-2026-20127 from numerous unique IP addresses.</p>
...
### Title: US Cyber Strategy Targets Adversaries, Critical Infrastructure, and Emerging Technologies
Link: https://www.securityweek.com/us-cyber-strategy-targets-adversaries-critical-infrastructure-and-emerging-technologies/
Summary: <p>Trump’s Cyber Strategy calls for stronger deterrence against cyber adversaries, modernization of federal networks, protection of critical infrastructure, and investment in technologies such as AI and post-quantum cryptography.</p>
...
### Title: Over 100 GitHub Repositories Distributing BoryptGrab Stealer
Link: https://www.securityweek.com/over-100-github-repositories-distributing-boryptgrab-stealer/
Summary: <p>The malware targets browser and cryptocurrency wallet data, along with system information and user files.</p>
